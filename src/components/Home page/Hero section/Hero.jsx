    ...
    <div className='bg-[#0a090d] pt-20 pb-20'>
        ...
        <div className="">
            <div className="text-white">
                ...
                <p className='outfit text-[18px] font-normal w-[750px] mt-6 text-[#aeaeb1]'>I've worked remotely with global teams, consulted with innovative startups, and partnered with creative
